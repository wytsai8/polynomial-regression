...
input_file_biochemical = "photoacoustic_biochemical.txt" #"photoacoustic_biochemical.txt" "optical_biochemical.txt"
input_file_image = "photoacoustic_image.txt" #"photoacoustic_image.txt"  "optical_image.txt"
...
VIF_result=VIF_functio1(linear_model,feature_file)
